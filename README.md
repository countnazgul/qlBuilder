...
* check for config and folders before run anything
* check for env details in config before run

---

If you have any issues, comments, suggestions etc please use the GitHub issue tracer **(link here)**
